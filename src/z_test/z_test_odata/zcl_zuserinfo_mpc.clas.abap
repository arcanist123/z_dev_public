class ZCL_ZUSERINFO_MPC definition
  public
...
public section.
  ...
  types:
         TS_ZUSERINFO type ZUSERINFO .
  types:
    TT_ZUSERINFO type standard table of TS_ZUSERINFO .
  types:
  ...
  constants GC_ZUSERINFO type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'zuserinfo' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZUSERINFO_MPC=============CP' ##NO_TEXT.

  methods DEFINE_ZUSERINFO
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZUSERINFO_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZUSERINFO_SRV' ).

define_zuserinfo( ).
  endmethod.


  method DEFINE_ZUSERINFO.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'zuserinfo' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZUSERINFO'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'UserCollection' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20180716153851'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'zuserinfo'.                            "#EC NOTEXT
